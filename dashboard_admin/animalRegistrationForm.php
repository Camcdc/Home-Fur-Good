...
<div class="form_container">
    ...
    <form action="registerAnimal.php" enctype="multipart/form-data" method="POST">
        ...
        <div class="form_row">
            ...
            <div class="form_group">
                ...
                <select name="kennelID" id="kennelID">
                    ...
                    $sql1 = "SELECT kennelID, occupation, capacity, kennelType, sizeRequirement FROM kennel ORDER BY kennelID";
                    ...
                    while($row = $result->fetch_assoc()){
                        ...
                        $label = "Kennel $kennelNumber (" . ($isFull ? "Full" : "$occupation/$capacity") . ") - " . $sizeRequirement . "";
            ...
            <div class="form_group">       
                <label for="species">Species:</label>
                    <div class="radio-group">
                        ...
                        <label for ="horse">Horse:<input type="radio" id='horse' name='species' value='Horse'></label>
                        <label for ="donkey">Donkey:<input type="radio" id='donkey' name='species' value='Donkey'></label>
                        <label for ="goat">Goat:<input type="radio" id='goat' name='species' value='Goat'></label>
                    </div>
            </div>
        ...
        <div class="form_group">
            ...
            <select id="rescueCircumstance" name="rescueCircumstance" required onchange="toggleOtherCircumstance()">
